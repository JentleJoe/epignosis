...
const Hero = () => {
  ...
  return (
    <section className="py-[80px] px-5 pb-[100px] bg-[#0a0a0a] relative overflow-hidden min-h-screen max-lg:py-[60px] max-lg:pb-[80px] max-lg:min-h-auto max-md:py-10 max-md:pb-[60px]">
      {/* Background glow */}
